...
const Home = () => {
  ...
  const fetchSuppliers = async () => {
    try {
      const response = await fetch("https://back-650z.onrender.com/api/suppliers");
  ...
  const categories = [
    ...
    "Chainsaw",
    "Cutter",
    "Solar Powered 4G Network Camera Kit",
    ...
    "GPS Total Station",
    "Sensor Faucet",
    "Locomotive Airbag Vest",
    "Stacking Pot",
    "Electric portable Kettle",
    "Wall",
    "Fence",
    "Solar Powered Cold",
    "Storage Facility",
